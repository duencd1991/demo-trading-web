...
import { subscribeRealtimeTickTopNewHigh } from './reducer';
import ScrollComponent from './../../../common/ScrollComponent';
import { compose } from 'redux';
import withPreRender from '../../../common/withPreRender';
import ConstCommon from './../../../common/Const';

const TopNewHigh = ({ indexTab, changeIndex, typeTab, changeType }) => (
  <ScrollComponent>
...
const mapDispatchToProps = {
  dispatchRealtime: subscribeRealtimeTickTopNewHigh,
};

export default compose(
  withPreRender(ConstCommon.listComponent.TopNewHigh),
  connect(
    null,
    mapDispatchToProps,
  ),
