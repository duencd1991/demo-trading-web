...
import { subscribeRealtimeTickTopGainers } from './reducer';
import ScrollComponent from './../../../common/ScrollComponent';
import { compose } from 'redux';
import withPreRender from '../../../common/withPreRender';
import ConstCommon from './../../../common/Const';

const TopGainers = ({ indexTab, changeIndex, typeTab, changeType }) => (
  <ScrollComponent>
...
const mapDispatchToProps = {
  dispatchRealtime: subscribeRealtimeTickTopGainers,
};

export default compose(
  withPreRender(ConstCommon.listComponent.TopGainers),
  connect(
    null,
    mapDispatchToProps,
  ),
