...
class PriceInfo extends React.Component {
  ...
  render() {
    ...
    const MatchPrice =
      indexData === null || typeof indexData === 'undefined'
        ? 0
        : indexData.matchPrice;
    const PriceChange =
      indexData === null || typeof indexData === 'undefined'
        ? 0
    ...
    const PercentPriceChange =
      indexData === null || typeof indexData === 'undefined'
        ? 0
        : indexData.percentPriceChange;
    const ReferencePrice =
      indexData === null || typeof indexData === 'undefined'
        ? 0
        : indexData.referencePrice;
