...
class ExportToCSV extends React.Component {
  ...
  render() {
    return (
      <div className="pd-top-navigation--right pd-top-navigation--right-indica pb-10">
        <a href="#" onClick={this.initialInforExportCSV} className="btn btn-cus-nomal bg-b-color-3">
