...
var _EdgeCoordinateV3 = require("./EdgeCoordinateV3");
...
var PriceCoordinate = function (_Component) {
	...
	_createClass(PriceCoordinate, [{
		...
		value: function drawOnCanvas(ctx, moreProps) {
			...
			(0, _EdgeCoordinateV3.drawOnCanvas)(ctx, props);
		}
	}, {
		key: "renderSVG",
		value: function renderSVG(moreProps) {
			var props = helper(this.props, moreProps);
			return (0, _EdgeCoordinateV3.renderSVG)(props);
		}
	}, {
		key: "render",
...
function helper(props, moreProps) {
  ...
  var x1 = 0,
    /* ========== CUSTOM CODE START========= */
    /* increase line length to reach rectangular  */
    // x2 = width;
    x2 = width + rectWidth / 2;
    /* ========== CUSTOM CODE END ========== */
    ...
    rectRadius: rectRadius, // add rectRadius to round-border rectangular
