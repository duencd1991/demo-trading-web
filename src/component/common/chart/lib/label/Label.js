...
var _LabelAnnotation = require('react-stockcharts/lib/annotation/LabelAnnotation');
    ...
    },
    {
      ...
      value: function renderSVG(moreProps) {
        ...
        return _react2.default.createElement(
          _LabelAnnotation2.default,
          _extends({ yScale: getYScale(chartConfig) }, this.props, {
...
function drawOnCanvas2(ctx, props, context, moreProps) {
  ...
  if ((0, _utils.isDefined)(canvasOriginX))
...
function drawOnCanvas(ctx, props, moreProps) {
  ...
  var _helper = (0, _LabelAnnotation.helper)(
      props,
      xAccessor,
      xScale,
