...
var BarSeries = (function(_Component) {
  ...
  function BarSeries(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (BarSeries.__proto__ || Object.getPrototypeOf(BarSeries)).call(
        this,
        props,
      ),
    );
 ...
 */
  ...
  var bars = plotData
    ...
    .map(function(d) {
      ...
      if (props.widthChart < props.minWidthHideLabel) {
        return {
          // type: "line"
          x: x,
          y: Math.round(y),
      ...
      return {
        ...
        fill: getFill(d, 0),
        stroke: stroke ? getFill(d, 0) : 'none',
        title: d.ticker, // todo: add title under bar
        valueY: yValue, // todo: add contribution under bar
        valueX: xValue, // todo: add contribution left or right bar
        heightChart: props.heightChart, // todo
      };
    });
