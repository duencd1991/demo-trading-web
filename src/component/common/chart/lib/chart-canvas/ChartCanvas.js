...
var _zoomBehavior = require('react-stockcharts/lib/utils/zoomBehavior');
...
var _CanvasContainer = require('react-stockcharts/lib/CanvasContainer');

var _CanvasContainer2 = _interopRequireDefault(_CanvasContainer);

var _evaluator2 = require('react-stockcharts/lib/scale/evaluator');
  ...
  _createClass(ChartCanvas, [
    ...
    },
    {
      ...
      value: function handleMouseMove(mouseXY, inputType, e) {
        //  var onMouseMove = this.props.onMouseMove(mouseXY, inputType, e);
        var _this6 = this;
    ...
    },
    {
      ...
      value: function handleMouseLeave(e) {
        // if hover Synchronizing Tooltip mouse leave
        if (this.props.isSynchronizingTooltip) {
          var onMouseLeave = this.props.onMouseLeave(e);
        }
        // end if hover Synchronizing Tooltip mouse leave
    ...
    },
    {
      ...
      value: function componentDidMount() {
        var _thisa = this;
        var _state6 = _thisa.state,
          chartConfig = _state6.chartConfig,
          plotData = _state6.plotData,
          xScale = _state6.xScale,
          xAccessor = _state6.xAccessor,
          _props = _thisa.props,
          _isSynchronizingTooltip = _props.isSynchronizingTooltip;

        // if hover Synchronizing Tooltip
        if (_isSynchronizingTooltip) {
          //add event Synchronizing
          var _eventSynchTooltipName = _props.eventSynchTooltipName;
          window.addEventListener(_eventSynchTooltipName, function(e) {
            //add if mouse move
            if (e.detail.isMouseMove) {
              var currentCharts = (0, _ChartDataUtil.getCurrentCharts)(
                chartConfig,
                e.detail.mouseXY,
              );
              ...
              _thisa.triggerEvent('mousemove', {
                show: true,
                mouseXY: e.detail.mouseXY,
                prevMouseXY: e.detail.prevMouseXY,
                currentItem: currentItem,
                currentCharts: currentCharts,
              });
              requestAnimationFrame(function() {
                _thisa.clearMouseCanvas();
                _thisa.draw({ trigger: 'mousemove' });
                _thisa.waitingForMouseMoveAnimationFrame = false;
              });
            } else {
              //add if mouse leave
              _thisa.triggerEvent('mouseleave', { show: false }, e);
              _thisa.clearMouseCanvas();
              _thisa.draw({ trigger: 'mouseleave' });
            }
          });
        }
        // if hover Synchronizing Tooltip
    ...
    },
    {
      ...
      value: function render() {
        var _props2 = this.props,
          ...
          isSynchronizingTooltip = _props2.isSynchronizingTooltip,
          eventSynchTooltipName = _props2.eventSynchTooltipName,
...
ChartCanvas.propTypes = {
  ...
  isSynchronizingTooltip: _propTypes2.default.bool,
  eventSynchTooltipName: _propTypes2.default.string,
};
